# 🗺️ School Greening Dashboard: User Tutorial
...
The map is the heart of the dashboard. Every point on the map represents a school, and the polygons/colors represent the underlying environmental or social data.
...
- **Schools & Parks:** Toggle traditional schools, specific greening opportunity sites (like GSA sites), and existing parks.
